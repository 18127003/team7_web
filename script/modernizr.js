...
(window.Modernizr = (function (a, b, c) {
  ...
  for (var B in o)
    u(o, B) &&
      ((s = B.toLowerCase()), (e[s] = o[B]()), r.push((e[s] ? "" : "no-") + s));
  v(""),
    (j = l = null),
    a.attachEvent &&
      (function () {
          ...
          (d.writeHTML = function () {
            ...
            while (++a < g) {
              var c = b.getElementsByTagName(f[a]),
                ...
                e = -1;
              while (++e < d)
                c[e].className.indexOf("iepp_") < 0 &&
                  (c[e].className += " iepp_" + f[a]);
            }
            l.appendChild(r),
              m.appendChild(o),
    ...
    (e.testAllProps = A),
    (g.className =
      g.className.replace(/\bno-js\b/, "") + (f ? " js " + r.join(" ") : ""));
  return e;
})(this, this.document)),
  (function (a, b, c) {
    function k(a) {
    ...
    function i(a) {
      ...
      (c.src = a.s),
        (c.onreadystatechange = c.onload = function () {
          !d &&
            k(c.readyState) &&
            ((d = 1), j(), (c.onload = c.onreadystatechange = null));
        }),
        m(function () {
          d || ((d = 1), j());
        }, H.errorTimeout),
    ...
    function e(a, b, c) {
      ...
      (q = 0),
        ...
        C(a)
          ? f(d, a, b, this.i++, l, c)
          : (p.splice(this.i++, 0, a), p.length == 1 && g());
      return this;
    }
    function d() {
      var a = H;
      ...
      function e(a, b, e, g, h) {
        ...
        if (!i.bypass) {
          b &&
            (b = D(b)
              ? b
              : b[a] || b[g] || b[a.split("/").pop().split("?")[0]]);
          if (i.instead) return i.instead(a, b, e, g, h);
          e.load(
            i.url,
            i.forceCSS || (!i.forceJS && /css$/.test(i.url)) ? "c" : c,
            i.noexec
          ),
            (D(b) || D(j)) &&
              e.load(function () {
